  ...
  <form action="/Servlet-JSP/ItemController" method="post" onsubmit="return validateForm()">
    <div class="form-row">
      <div class="input-data">
        <input type="text" required name="name" id="name" pattern=".{2,}" title="Name must be at least 2 characters">
        <div class="underline"></div>
        <label>Name</label>
        <span class="error-message">Name must be at least 2 characters</span>
      </div>
      <div class="input-data">
        <input type="number" required name="price" id="price" step="0.01" min="0.01" title="Price must be a positive number">
        <div class="underline"></div>
        <label>PRICE</label>
    ...
    <div class="form-row">
      <div class="input-data">
        <input type="number" required name="totalNumber" id="totalNumber" min="0" step="1" title="Total number must be a non-negative integer">
        <div class="underline"></div>
